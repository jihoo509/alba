...
// 스타일 정의
const btnStyle = {
  padding: '8px 4px', backgroundColor: '#fff', border: '1px solid #ccc', borderRadius: 6,
  fontSize: '13px', color: '#333', minWidth: '45px', textAlign: 'center' as const, cursor: 'pointer'
};

const modalOverlayStyle = {
  position: 'fixed' as const, top: 0, left: 0, right: 0, bottom: 0,
  backgroundColor: 'rgba(0,0,0,0.5)', zIndex: 9999,
  // ✅ [수정] 아래쪽(flex-end) -> 중앙(center)으로 변경
  display: 'flex', justifyContent: 'center', alignItems: 'center', 
};

const modalContentStyle = {
  width: '90%', maxWidth: '360px', // 모바일 너비 대응
  backgroundColor: '#fff',
  // ✅ [수정] 전체 둥글게 처리
  borderRadius: '12px',
  padding: '20px',
...
const modalHeaderStyle = {
  ...
  marginBottom: '20px', fontWeight: 'bold', fontSize: '16px', color: '#333'
};

const closeBtnStyle = {
  border: 'none', background: 'none', color: '#999', fontSize: '14px', padding: '4px 8px', cursor: 'pointer'
};
