    ...
    <div className="page-container">
      <style jsx global>{`
        ...
        body {
          ...
          margin: 0; padding: 0; background-color: #f5f6f8; color: #333; overflow-x: hidden;
        }
      ...
      <style jsx>{`
        ...
        .calc-input-time { padding-right: 40px; }
        ...
        .tip-box { background-color: #f2f4f6; padding: 16px; border-radius: 14px; margin-top: 20px; }
        .tip-title { font-size: 14px; font-weight: 800; color: #333; margin-bottom: 8px; }
        .tip-list { list-style: none; padding: 0; margin: 0; font-size: 13px; color: #555; line-height: 1.5; }
      ...
      <div className="calculator-section">
        <div className="card">
          ...
          <p style={{ textAlign: 'center', color: '#8b95a1', marginBottom: '30px', fontSize: '15px' }}>복잡한 주휴수당, 바로 확인해보세요!</p>
